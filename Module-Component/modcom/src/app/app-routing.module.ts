...
const routes: Routes = [
  ...
  {path:'',component: HomeComponent}, //urlde nasıl görünmesi isteniyor.
  {path:'**',component: NotFoundComponent} //içerisinde hiçbir pathle eşleşmiyorsa not found için iki * gerekiyor.
];
